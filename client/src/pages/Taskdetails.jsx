         ...
         <Tabs tabs={TABS} setSelected={setSelected}>
            {
              selected === 0 ? (
                <>
                  <div className='w-full flex flex-col md:flex-row gap-5 2xl:gap-8 bg-transparent shadow-md p-8 overflow-y-auto'>
                    {/* Left Side  */}
      ...
      <div className='flex space-x-4'>
        ...
        <div className='flex flex-col gap-y-1 mb-8'>
          ...
          <div className='text-gray-500 space-y-2'>
            <span className='capitalize pr-1'>{item?.type}</span>
